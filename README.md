...
After clicking "Upload All to Youtube" on the GUI, users should be asked to sign in to the Google account associated with their YouTube account, and all of the outputted .MP4 files in the "output" directory will upload to YouTube.
