...
Follow the steps <a href="https://developers.google.com/youtube/v3/guides/uploading_a_video">here</a> under the "Requirements" heading. Configure your YouTube API <a href="https://console.cloud.google.com/apis/dashboard">here</a>. Once the YouTube Data API has been configured, paste the correct "client_id" and "client_secret" in the already
existing client_secrets.json file.
